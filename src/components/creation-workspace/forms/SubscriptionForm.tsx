...
export function SubscriptionForm({ data, onChange, errorFields, onAddObject }: SubscriptionFormProps) {
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      ...
      <SelectField label="Billing interval" value={data.interval ?? "monthly"} onChange={(v) => set("interval", v)}>
      ...
      <div className="flex flex-col gap-[4px]">
        ...
        <textarea
          className="min-h-[80px] w-full resize-none rounded-[6px] border border-[#D4DEE9] bg-white px-[10px] py-[8px] text-[13px] font-[400] text-[#353A44] placeholder:text-[#9CA3B0] outline-none transition-colors focus:border-[#533AFD] focus:ring-1 focus:ring-[#533AFD]/20"
